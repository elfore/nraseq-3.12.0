...
if (!require("dupRadar")){
    stop("dupRadar package not found. Please ensure it is installed in your R environment.")
}
if (!require("parallel")) {
    stop("parallel package not found. Please ensure it is installed in your R environment.")
}
